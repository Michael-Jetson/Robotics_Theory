...
\textbf{初始化}：一个策略函数 $\pi(a | s, \theta_{0})$，其中 $\theta_{0}$ 是初始参数。一个价值函数 $q(s, a, w_{0})$，其中 $w_{0}$ 是初始参数。$\alpha_{w}, \alpha_{\theta} > 0$。
...
\textbf{初始化}：策略函数 $\pi(a | s, \theta_{0})$，其中 $\theta_{0}$ 是初始参数。价值函数 $v(s, w_{0})$，其中 $w_{0}$ 是初始参数。$\alpha_{w}, \alpha_{\theta} > 0$。
...
\textbf{初始化}：给定的行为策略 $\beta(a | s)$。确定性目标策略 $\mu(s, \theta_{0})$，其中 $\theta_{0}$ 是初始参数。价值函数 $q(s, a, w_{0})$，其中 $w_{0}$ 是初始参数。$\alpha_{w}, \alpha_{\theta} > 0$。

...
%  记号归一：R in SO(3)、T in SE(3)（preamble 宏 \SO \SE \so \se）；力学/接触/优化自然记号保留。
...
\subsection*{科研发展脉络}
多机协同搬运是\emph{四十年理论积淀（1986 起）$+$ 近五年学习革命}的领域。下表勾勒主线（论文归属、年份、卷期、数值均按源稿重述）。

{\small\centering
\begin{longtable}{C{0.9cm}p{4.6cm}C{2.0cm}p{4.6cm}}
\caption{协同搬运与多机力控发展脉络}\label{tab:cm-history}\\
\toprule

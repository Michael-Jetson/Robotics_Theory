...
\section{内置单元清单}
彩色定理类：\texttt{theorem /\allowbreak  definition /\allowbreak  lemma /\allowbreak  corollary /\allowbreak  proposition /\allowbreak  axiom /\allowbreak  postulate}；
练习类：\texttt{example /\allowbreak  exercise /\allowbreak  problem}；
说明类：\texttt{proof / solution / note / remark / assumption / conclusion / property / custom\{标题\}}；
版块类：\texttt{introduction /\allowbreak  problemset}。星号版（\texttt{theorem*} 等）不编号。
